...
/* static bool Inside(const int3 p, const int width) { */
/*   return (p.x >= 0 && p.y >= 0 && p.z >= 0 && */
/*           p.x <= width && p.y <= width && p.z <= width); */
/* } */

/* static int FindLVertex(const LVertex lv, LVertex* array, const int size) { */
...
/* static int FindLVertexWithLabel( */
...
/* // element is returned. */
/* static LVertex PopLVertex(LVertex* array, int* size, const int label) { */
...
/* static int FindInt(const int val, int* array, const int size) { */
/*   for (int i = 0; i < size; ++i) { */
/*     if (array[i] == val) */
/*       return i; */
/*   } */
...
/* static bool AddInt(const int val, int* array, int* size) { */
/*   if (*size == MAX_SIZE) return false; */
/*   array[(*size)++] = val; */
/*   return true; */
/* } */
...
/* static int3 NeighborPosition( */
/*     global const Vertex* v, const int3 v_p, const Direction d) { */
...
/*   global const Vertex* base_v = &vertices[base_vi]; */
...
/*   LVertex base_lv = */
/*       { base_vi, int3(0), point_labels[v_closest_point(*base_v)] }; */
...
/*     global const Vertex* v = &vertices[vi]; */
...
/*           global const Vertex* n_v = &vertices[n_vi]; */
/*           const LVertex n_lv = */
